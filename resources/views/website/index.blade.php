                ...
                <svg width="18" height="18" class="text-warning"><use xlink:href="#star-half"></use></svg>
                                      ...
                                      <div class="button-area p-3 pt-0">
                                          <div class="row g-1 mt-2">
                                              ...
                                              <div class="col-7"><a href="{{route('login')}}" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart"><svg width="18" height="18"><use xlink:href="#cart"></use></svg> Add to Cart</a></div>
                ...
                <div class="product-item swiper-slide">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
                          <div class="col-3">
                              <input type="number" name="quantity" class="form-control border-dark-subtle input-number quantity" value="1" min="0">
                          </div>
                        <div class="col-7"><a href="{{route('login')}}" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart"><svg width="18" height="18"><use xlink:href="#cart"></use></svg> Add to Cart</a></div>
                        <div class="col-2"><a href="#" class="btn btn-outline-dark rounded-1 p-2 fs-6"><svg width="18" height="18"><use xlink:href="#heart"></use></svg></a></div>
                      </div>
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{asset('admin-images/blog/'.$blog->image)}}" alt="post" class="card-img-top" style="width: 300px; height: 150px";>
                </a>
              </div>
              <div class="card-body">
