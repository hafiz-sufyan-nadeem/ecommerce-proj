...
<div id="offcanvasCart" class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1">
    ...
    <div class="offcanvas-body">
        <div class="order-md-last">
            ...
            <a href="{{ route('checkout') }}" class="w-100 btn btn-primary btn-lg" type="submit">Continue to
                checkout</a>
        </div>
    </div>
</div>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <form class="card p-2">
                <div class="input-group">
                    ...
                    <input type="number" id="T_cost" class="form-control" value="1000" style="display: none;">
...
{{--                    </div>--}}
                ...
                <div class="d-block my-3">
                    <div class="custom-control custom-radio">
                        <input id="credit" name="payment_method" type="radio" value="Credit Card" class="custom-control-input" checked>
